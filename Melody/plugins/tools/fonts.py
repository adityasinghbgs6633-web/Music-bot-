...
def get_font_markup(user_id: int, page: int = 0) -> InlineKeyboardMarkup:
    ...
    nav_row.append(InlineKeyboardButton("", callback_data=f"n|{prev_page}|{user_id}", icon_custom_emoji_id="5447506720316225765"))
    ...
    nav_row.append(InlineKeyboardButton("", callback_data=f"n|{next_page}|{user_id}", icon_custom_emoji_id="5445350109862720603"))
    
    keyboard.append(nav_row)

    # Close button
    close_btn = InlineKeyboardButton("Cʟᴏsᴇ", callback_data=f"c|{user_id}", icon_custom_emoji_id="5992179264315723303")
