...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command in ["Pause", "Resume", "Toggle"]:
        ...
        if command == "Skip":
            txt = f"<emoji id=5445350109862720603></emoji> ➻ sᴛʀᴇᴀᴍ sᴋɪᴩᴩᴇᴅ\n│ \n└ʙʏ : {mention}"
            popped = None
            try:
                popped = check.pop(0)
                if popped:
                ...
                if not check:
                    await CallbackQuery.edit_message_text(
                        f"<emoji id=5445350109862720603></emoji> ➻ sᴛʀᴇᴀᴍ sᴋɪᴩᴩᴇᴅ\n│ \n└ʙʏ : {mention}"
                    )
                    await CallbackQuery.message.reply_text(
            ...
            txt = f"<emoji id=5994329071541031559></emoji> ➻ sᴛʀᴇᴀᴍ ʀᴇ-ᴘʟᴀʏᴇᴅ\n│ \n└ʙʏ : {mention}"
        ...
        if "live_" in queued:
            ...
            run = await CallbackQuery.message.reply_photo(
                ...
                message_thread_id=check[0].get("thread_id"),
            )
