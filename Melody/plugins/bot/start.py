        ...
        if name.startswith("inf"):
            ...
            try:
                ...
                key = InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(text=_["S_B_8"], url=result["link"], icon_custom_emoji_id="6298429115628259446"),
                        InlineKeyboardButton(text=_["S_B_9"], url=f"https://t.me/{config.SUPPORT_GROUP}", icon_custom_emoji_id="5994291189929480156"),
                    ]]
                )
