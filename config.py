...
SHRUTI_API_KEY = os.getenv("SHRUTI_API_KEY", "ShrutiBots03yonFGPTd6g1ju3r8Y5")

# --- Image URLs ---
START_IMG_URL = os.getenv("START_IMG_URL", "https://files.catbox.moe/efysvz.jpg")
_DEFAULT_IMG = os.getenv("_DEFAULT_IMG", "https://files.catbox.moe/efysvz.jpg") 
...
class BoundedDict(OrderedDict):
    """A dictionary that limits its maximum size to prevent memory leaks."""
...
adminlist = BoundedDict(maxsize=1000)
lyrical = BoundedDict(maxsize=1000)
votemode = BoundedDict(maxsize=1000)
autoclean = []
confirmer = BoundedDict(maxsize=1000)
